...
def build_encoder_decoder(inputs, num_classes, preset_model = "Encoder-Decoder", dropout_p=0.5, scope=None, layers=16):
	"""
	...
	if layers not in SUPPORTED_LAYERS:
		raise ValueError("Unsupported Encoder-Decoder layers '%d'. This function only supports 11, 13, 16 or 19 layers" % (layers))
