...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--skip_pad_images', action='store_true', help='Skip: padding images')
        ...
        # parser.add_argument('--layers', required=False, default=16, type=int, help='Number of layers in case of the Encoder-Decoder model')
